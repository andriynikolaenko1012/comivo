...
public class OrderSignedSellerActivity extends AppCompatActivity{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) OrderSignedSellerActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(OrderSignedSellerActivity.this.getComponentName()));
        }
