...
public class ChemicalQuestionsCommentsActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) ChemicalQuestionsCommentsActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(ChemicalQuestionsCommentsActivity.this.getComponentName()));
        }
    ...
    private void initViews(){
        ...
        leftButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChemicalQuestionsCommentsActivity.this, CommunityActivity.class);
