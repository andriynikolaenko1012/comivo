...
public class MembershipActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) MembershipActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(MembershipActivity.this.getComponentName()));
        }
