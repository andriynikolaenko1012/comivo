...
public class QuoteDetailsActivity extends AppCompatActivity{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) QuoteDetailsActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(QuoteDetailsActivity.this.getComponentName()));
        }
