...
public class ChemicalAnswerDetailsActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) ChemicalAnswerDetailsActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(ChemicalAnswerDetailsActivity.this.getComponentName()));
        }
    ...
    private void initViews(){
        ...
        leftButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChemicalAnswerDetailsActivity.this, CommunityActivity.class);
