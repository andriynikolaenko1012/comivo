...
public class ChangePassActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) ChangePassActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(ChangePassActivity.this.getComponentName()));
        }
